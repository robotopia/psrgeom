 ...
 * Sam McSweeney, 2018
 *
 * This program calculates the curvature of the trajectory of a particle
 * as a function of position in the plane containing the magnetic axis and
 * makes an angle sigma to the fiducial plane (i.e. has a constant magnetic
 * azimuth).
 * The pulsar is chosen by the user to have angles α and ζ, and period P.
 *
...
void usage()
{
    ...
    printf( "  -P  period   The rotation period of the pulsar, in seconds "
                           "(required)\n" );
    printf( "  -p  azimuth  The azimuth relative to the magnetic axis, "
                           "in degrees.\n"
